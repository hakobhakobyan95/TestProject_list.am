...
public class AssertFor extends Screen {
    ...
    private By newCondition = By.xpath("//div[contains(text(),'New')]");
    ...
    private By shoesNumber = By.xpath("//div[@class='i'][contains(text(),'43')]");
    ...
    private By type = By.xpath("//div[contains(text(),'Stone')]");
    ...
    private By room = By.xpath("//body/div/div[@class='pmain']/div/div[@class='vi']/div[2]/div[2]/div[2]");
    ...
    private By floor = By.xpath("//div[@class='vi']//div[4]//div[2]");
    ...
    private By space = By.xpath("//div[contains(text(),'60 m')]");
    ...
    //for case 8
    private By element1 = By.id("bList");
    ...
    //for case 11
    private By engineType = By.name("_a15");
    ...
    //for case 12
    private By pathPage = By.id("crumb");
    ...
    //for case 13
    private By agencyXpath = By.xpath("//span[@class='clabel']");
    ...
    //for case 14
    private By locationYerevan = By.xpath("//div[@class='loc']//a");
    ...
    private By wrongFloor = By.xpath("//div[@class='notfound']");
    ...
    private By permanent = By.xpath("//div[contains(text(),'Permanent')]");
    ...
    private By schedule = By.xpath("//div[contains(text(),'Full time')]");
    ...
    //for case 18
    private By generalInfo = By.className("grp");
    ...
    //    for case 19
    private By crumbName = By.className("crumbnb");
    ...
    private By info = By.xpath("//div[@class='info']");
    ...
    private By errorMessage = By.xpath("//div[contains(text(),'This field is too short')]");
    ...
    private By changedText = By.xpath("//div[@class='body']");
    ...
    private By adCount = By.xpath("//span[contains(text(),'1')]");
    ...
    // for case 25
    private By count = By.xpath("//div[contains(text(),'Ads')]//span");
    ...
    private By inactiveNumber = By.xpath("//span[@class='i']");
    ...
    private By viberNumberCheck = By.xpath("//div[@class='i viber']//div[1]");
    ...
    //for case 28
    private By replyButton = By.xpath("//input[@name='Reply']");
    ...
    // for case 30
    private By page = By.xpath("//span[@class='c']");
